...
# La function loadData2 est creer pour Question 7
...
# QUESTION 2 : FUNCTION initCentroids(...) #
...
# Question 3 : FUNCTION assignToCluster(...) #
# On a defit 3 functions pour calDistance(), closestcentroide(), assignToCluster()
...
# Trouver la centoide la plus proche #
...
def assignToCluster(rdd,centroids):
    ...
    # calculer le distance entre les points et chaque centroides
...
def computeIntraClusterDistance(rdd,centroids):
    ...
    # [(1, 502.244)] la premier numero n'a pas de sense, la deuxime numero est la distance total

    return totaldistance



# Question 6 est dans le function main
# Question 7 :  file est le fichier contenant les points a partitionner, k est le nombre de clusters
# m est le nombre de maximum d'iterations
...
def kmeans(file,k,m):
    ...
    # [(1, 935.883)] le premier chiffre n'a pas de sense, 935.883 est la distance.

    # apres le premier appel computeCentroids()
    total_newcentroide = computeIntraClusterDistance(rdd,newcentroids)
    # [(1, 291.450)]  Le nouveau distance est plus petite que la distance initial.
...
###############################################################################
# la fonction kmeans2 est identique a la fonctiton kmeans, sauf qu'il ne affiche pas le nombre iteration et distance finale
# Cette fonction est pour Question 8 parce que je veux pas afficher les resultat 100 fois
...
# Question 8
    print "Reprosuiser l'experience 100 fois:(il prends un peu de temps)"
